...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------|:---------------------------|:------------------|
| Locale identifier consisting of a [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) or [ISO 639-3](https://en.wikipedia.org/wiki/ISO_639-3) language code plus an optional country identifier separated by a hyphen (`-`). For example `"fr"` or `"de-CH"`. | `salim.locale`           | `R_SALIM_LOCALE`           | `"en"`            |
