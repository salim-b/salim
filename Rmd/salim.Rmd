...
-   Transparent background; `ggplot2::theme_minimal()` already makes plot background transparent. The explicit way to make plot background transparent would be
    ...
    ggplot2::theme(panel.background = ggplot2::element_rect(fill = "transparent",
                   ...
                   legend.key = ggplot2::element_rect(fill = color_report_bg))
    ```
    ...
    Thus we set the background color to `color_report_bg`.
